...
export interface Subject {
  ...
  export const predefinedSubjects = [
    ...
    { code: 'COE0015', name: 'PHYSICS FOR ENGINEERS 2 (LEC)', units: '2', year: '1', semester: '3', grade: '', prerequisites: ['COE0009', 'COE0009L','COE0007'] },
    ...
    { code: 'COE0015L', name: 'PHYSICS FOR ENGINEERS 2 (LAB)', units: '1', year: '1', semester: '3', grade: '', prerequisites: ['COE0009','COE0009', 'COE0007'] },
    { code: 'COE0017L', name: 'CHEMISTRY FOR ENGINEERS 2 (LAB)', units: '1', year: '1', semester: '3', grade: '', prerequisites: ['COE0005'] },
    ...
    { code: 'CPE0011', name: 'FUNDAMENTALS OF ELECTRONIC CIRCUITS (LEC)', units: '3', year: '2', semester: '2', grade: '', prerequisites: ['CPE0005','CPE0005L'] },
    ...
    { code: 'CPE0011L', name: 'FUNDAMENTALS OF ELECTRONIC CIRCUITS (LAB)', units: '1', year: '2', semester: '2', grade: '', prerequisites: ['CPE0005','CPE0005L'] },

    // 2ND YEAR 3RD SEM
    { code: 'COE0039', name: 'ENGINEERING ECONOMICS', units: '3', year: '2', semester: '3', grade: '', prerequisites: ['COE0011'] },
    { code: 'CPE0015L', name: 'COMPUTER ENGINEERING DRAFTING AND DESIGN', units: '1', year: '2', semester: '3', grade: '', prerequisites: ['CPE0011','CPE0011L'] },
    { code: 'CPE0017L', name: 'OBJECT ORIENTED PROGRAMMING', units: '2', year: '2', semester: '3', grade: '', prerequisites: ['CPE0007L'] },
    { code: 'CPE0019', name: 'FUNDAMENTALS OF MIXED SIGNALS AND SENSORS', units: '3', year: '2', semester: '3', grade: '', prerequisites: ['CPE0011','CPE0011L'] },
    { code: 'CPE0021', name: 'LOGIC CIRCUITS AND DESIGN (LEC)', units: '3', year: '2', semester: '3', grade: '', prerequisites: ['CPE0011','CPE0011L'] },
    { code: 'CPE0023', name: 'DATA AND DIGITAL COMMUNICATION', units: '3', year: '2', semester: '3', grade: '', prerequisites: ['CPE0011','CPE0011L'] },
    { code: 'CPE0025', name: 'FEEDBACK AND CONTROL SYSTEM', units: '3', year: '2', semester: '3', grade: '', prerequisites: ['CPE0005','CPE0005L', 'CPE0013'] },
    { code: 'CPE0021L', name: 'LOGIC CIRCUITS AND DESIGN (LAB)', units: '1', year: '2', semester: '3', grade: '', prerequisites: ['CPE0011','CPE0011L'] },
    ...
    { code: 'CPE0027L', name: 'Introduction to HDL', units: '1', year: '3', semester: '1', grade: '', prerequisites: ['CPE0021','CPE0021L'] },
    { code: 'CPE0029', name: 'MICROPROCESSORS (LEC)', units: '3', year: '3', semester: '1', grade: '', prerequisites: ['CPE0021','CPE0021L'] },
    { code: 'CPE0031', name: 'COMPUTER NETWORKS AND SECURITY (LEC)', units: '3', year: '3', semester: '1', grade: '', prerequisites: ['CPE0023'] },
    { code: 'CPE0071', name: 'TECHNICAL ELECTIVE FOR CPE', units: '2', year: '3', semester: '1', grade: '', prerequisites: ['CPE0021','CPE0021L'] },
    { code: 'GED0049', name: 'LIFE AND WORKS OF RIZAL', units: '3', year: '3', semester: '1', grade: '', prerequisites: [] },
    { code: 'CPE0029L', name: 'MICROPROCESSORS (LAB)', units: '1', year: '3', semester: '1', grade: '', prerequisites: ['CPE0021','CPE0021L'] },
    ...
    { code: 'CPE0035', name: 'EMBEDDED SYSTEMS (LEC)', units: '3', year: '3', semester: '2', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    { code: 'CPE0035L', name: 'EMBEDDED SYSTEMS (LAB)', units: '1', year: '3', semester: '2', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    { code: 'CPE0037', name: 'COMPUTER ARCHITECTURE AND ORGANIZATION (LEC)', units: '3', year: '3', semester: '2', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    { code: 'CPE0037L', name: 'COMPUTER ARCHITECTURE AND ORGANIZATION (LAB)', units: '1', year: '3', semester: '2', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    { code: 'CPE0039L', name: 'Introduction to Database', units: '1', year: '3', semester: '2', grade: '', prerequisites: ['CPE0017L'] },
    { code: 'CPE0041', name: 'COGNATE/TRACK COURSE 1', units: '3', year: '3', semester: '2', grade: '', prerequisites: ['CPE0031','CPE0031L'] },
    { code: 'CPE0043', name: 'Methods of Research for CPE', units: '2', year: '3', semester: '2', grade: '', prerequisites: ['CPE0029','CPE0029L', 'GED0043', 'COE0049'] },

    // 3RD YEAR 3RD SEM
    { code: 'CPE0045L', name: 'CpE Practice and Design 1', units: '1', year: '3', semester: '3', grade: '', prerequisites: ['CPE0043', 'COE0059'] },
    { code: 'CPE0047', name: 'OPERATING SYSTEMS (LEC)', units: '3', year: '3', semester: '3', grade: '', prerequisites: ['CPE0037','CPE0037L'] },
    { code: 'CPE0047L', name: 'OPERATING SYSTEMS (LAB)', units: '1', year: '3', semester: '3', grade: '', prerequisites: ['CPE0037','CPE0037L'] },
    ...
    { code: 'CPE0051', name: 'EMERGING TECHNOLOGIES IN CPE', units: '3', year: '3', semester: '3', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    { code: 'CPE0053L', name: 'Seminars and Field Trips', units: '1', year: '3', semester: '3', grade: '', prerequisites: ['CPE0029','CPE0029L'] },
    ...
    //4TH YEAR 2ND SEM
    { code: 'CPE0067', name: 'INTERNSHIP 1 FOR CPE', units: '9', year: '4', semester: '2', grade: '' , prerequisites: ['CPE0031','CPE0031L','CPE0061'] },
